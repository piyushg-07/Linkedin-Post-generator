...
def clean_text(text):
    # Replace emojis and unsupported characters
    return re.sub(r'[^\x00-\x7F]+', '', text)


def process_posts(raw_file_path, processed_file_path = "data/raw_posts.json"):
    with open(raw_file_path, encoding='utf-8') as file:
        ...
        for post in posts:
            try:
                ...
                logging.error(f"Error processing post: {post['text']}\n{e}")
